package one.piece.marineford.core.dao.springjdbc;

import one.piece.marineford.annotation.dao.springjdbc.*;
 ...
 */
public abstract class SpringJDBCTemplate<T> extends JdbcDaoSupport {

    private static final Logger log = LoggerFactory.getLogger(SpringJDBCTemplate.class);
    ...
    private void initByAnnotation() {
        ...
        for (Method method : methodArray) {
            ...
            if (retClass.equals(String.class)) {
                ...
                throw new RuntimeException("类" + getClass().getName() + "上的属性" + propertyName + "的类型不被支持");
            }
            ...
            if (method.isAnnotationPresent(Id.class)) {
                ...
                if (old != null) {
                    throw new RuntimeException("类" + getClass().getName() + "上定义了多个主键");
                }
                ...
                if (old != null) {
                    ...
                    throw new RuntimeException("类" + getClass().getName() + "上的属性" + propertyName + "的getter方法不正确");
                }
                columnNameToField.put(f.getColumnName(), f);
                fields.add(f);
            }
